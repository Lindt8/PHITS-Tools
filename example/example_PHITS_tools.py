...
named_tuple_pickle_file = Path(dump_output_file.parent, dump_output_file.stem + '_namedtuple_list.pickle.xz')
dump_dataframe_file = Path(dump_output_file.parent, dump_output_file.stem + '_Pandas_df.pickle.xz')
if named_tuple_pickle_file.is_file() and dump_dataframe_file.is_file():
    with lzma.open(named_tuple_pickle_file, 'rb') as file: events_list = pickle.load(file)
